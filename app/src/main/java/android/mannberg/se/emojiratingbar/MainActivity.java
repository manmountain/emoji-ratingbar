        ...
        hurtbar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                switch ((int)rating) {
                    ...
                    case 3: msgview.setText(R.string.msg002); msg = "Everything will be all right "+getEmojiByUnicode(0x1F917); break;
                    case 4: msgview.setText(R.string.msg003); msg = "Double hug attack!! "+getEmojiByUnicode(0x1F917)+getEmojiByUnicode(0x1F917)+getEmojiByUnicode(0x1F60A); break;
                    case 5: msgview.setText(R.string.msg004); msg = "You are the best person I know, everything will be better and I can help you with whatever "+getEmojiByUnicode(0x1F607); break;
